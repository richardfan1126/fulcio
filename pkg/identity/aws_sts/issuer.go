...
func Issuer(issuerURL string) identity.Issuer {
	return &awsStsIssuer{base.Issuer(issuerURL)}
}

func (e *awsStsIssuer) Authenticate(ctx context.Context, token string, opts ...config.InsecureOIDCConfigOption) (identity.Principal, error) {
